<?php
    ...
    if(!preg_match($regex_email,$email)){
        echo "Email không đúng định dạng. Quay lại trang đăng ký...";
        ?>
    ...
    if(strlen($password)<6){
        echo "Mật khẩu phải có tối thiểu 6 ký tự. Quay lại trang đăng ký...";
        ?>
        <meta http-equiv="refresh" content="2;url=signup.php" />
        <?php
    }
    ...
    if($rows_fetched>0){
        ...
        echo "Người dùng đã đăng ký thành công.";
